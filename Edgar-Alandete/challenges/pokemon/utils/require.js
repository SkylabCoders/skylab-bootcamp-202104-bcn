...
(function (global, setTimeout) {
  let req; let s; let head; let baseElement; let dataMain; let src;
  let interactiveScript; let currentlyAddingScript; let mainScript; let subPath;
  const version = '2.3.6';
  ...
  function newContext(contextName) {
    let inCheckLoaded; let Module; let context; let handlers;
    ...
    function normalize(name, baseName, applyMap) {
      let pkgMain; let mapValue; let nameParts; let i; let j; let nameSegment; let lastIndex;
      let foundMap; let foundI; let foundStarMap; let starI; let normalizedBaseParts;
    ...
    function makeModuleMap(name, parentModuleMap, isNormalized, applyMap) {
      let url; let pluginModule; let suffix; let nameParts;
      let prefix = null;
    ...
    Module.prototype = {
      ...
      callPlugin() {
        ...
        on(pluginMap, 'defined', bind(this, function (plugin) {
          let load; let normalizedMap; let normalizedMod;
    ...
    context = {
      ...
      nameToUrl(moduleName, ext, skipExt) {
        let paths; let syms; let i; let parentModule; let url;
        let parentPath; let bundleId;

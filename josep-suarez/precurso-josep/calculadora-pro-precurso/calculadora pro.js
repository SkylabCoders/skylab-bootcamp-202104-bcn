...
function oper(operadores) {     
    const suma = operadores.reduce((accumulator, currentValue) => accumulator + currentValue);
    const resta = operadores.reduce((accumulator, currentValue) => accumulator - currentValue);
    const multi = operadores.reduce((accumulator, currentValue) => accumulator * currentValue);
    const division = operadores.reduce((accumulator, currentValue) => accumulator / currentValue);

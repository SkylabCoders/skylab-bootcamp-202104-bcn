...
function modifyElement(LiId, spanId) {
  ...
  newInput.setAttribute('class', 'header__ul-list--newInput');
  input.getAttribute('value');
  const buttonInput = createElement('button', 'Change', null, liToModify);
  buttonInput.setAttribute('class', 'header__ul-list--changeButton');
